...
import "./DaiWethTwapPriceOracle.sol";
import "hardhat/console.sol";

contract ResistantLendingProtocol is ILendingProtocol {
    ...
    DaiWethTwapPriceOracle private priceOracle;

    constructor(address daiWethTwapPriceOracleAddress) public {
        priceOracle = DaiWethTwapPriceOracle(daiWethTwapPriceOracleAddress);
    }

    /**
     * In this more resistant lending protocol, ETH price fetching is delegated
     * to a TWAP price oracle.
     */
    function getEthPrice() public view returns (uint256) {
        return priceOracle.getEthTwapPrice();
    }
